...
CONFIG_FILE="${CONFIG_FILE:-$ROOT/external/mmdetection3d/configs/fcos3d/fcos3d_r101-caffe-dcn_fpn_head-gn_2xb2-12e_kitti-mono3d_car.py}"
WORK_DIR="${WORK_DIR:-$ROOT/results/fcos3d_baseline_car}"
