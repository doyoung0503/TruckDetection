...
test_evaluator = dict(
    ...
    metric='bbox',
    submission_prefix=
    '/home/dy-jang/projects/TruckDetection-main/results/checkpoint_series_eval/fcos3d_seed40_val1000/epoch_012/submission',
    type='KittiMetric')
test_pipeline = [
    dict(backend_args=None, type='LoadImageFromFileMono3D'),
    dict(keep_ratio=True, scale=(
...
work_dir = '/home/dy-jang/projects/TruckDetection-main/results/checkpoint_series_eval/fcos3d_seed40_val1000/epoch_012/workdir'
