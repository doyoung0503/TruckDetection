...
launcher = 'none'
load_from = '/home/dy-jang/projects/TruckDetection-main/results/fcos3d/seed_40/epoch_8.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    metric='bbox',
    submission_prefix=
    '/home/dy-jang/projects/TruckDetection-main/results/checkpoint_series_eval/fcos3d_seed40_val1000/epoch_008/submission',
    type='KittiMetric')
test_pipeline = [
    dict(backend_args=None, type='LoadImageFromFileMono3D'),
    dict(keep_ratio=True, scale=(
...
work_dir = '/home/dy-jang/projects/TruckDetection-main/results/checkpoint_series_eval/fcos3d_seed40_val1000/epoch_008/workdir'
