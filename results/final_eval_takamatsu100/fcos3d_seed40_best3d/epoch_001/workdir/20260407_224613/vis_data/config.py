...
launcher = 'none'
load_from = '/home/dy-jang/projects/TruckDetection-main/results/fcos3d/seed_40/epoch_1.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/home/dy-jang/projects/v3/v3_takamatsu_100/kitti_mmdet3d_fcos3d',
...
test_evaluator = dict(
    ann_file=
    '/home/dy-jang/projects/v3/v3_takamatsu_100/kitti_mmdet3d_fcos3d/v3_infos_val.pkl',
    backend_args=None,
    format_only=True,
    metric='bbox',
    submission_prefix=
    '/home/dy-jang/projects/TruckDetection-main/results/final_eval_takamatsu100/fcos3d_seed40_best3d/epoch_001/submission',
    type='KittiMetric')
test_pipeline = [
    dict(backend_args=None, type='LoadImageFromFileMono3D'),
    dict(keep_ratio=True, scale=(
...
work_dir = '/home/dy-jang/projects/TruckDetection-main/results/final_eval_takamatsu100/fcos3d_seed40_best3d/epoch_001/workdir'
